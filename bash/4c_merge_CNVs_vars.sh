...
#SBATCH --nodes=1
#SBATCH --mem=64gb
#SBATCH --output=CNV_merge_%j.out
#SBATCH --error=CNV_merge_%j.err

# Set paths
OUT_DIR="/gs/gsfs0/shared-lab/greally-lab/David/AlleleStacker_tests/AlleleStacker_11-20-24/outputs/merged_variants/copy_number_variants"
...
FILEPATHS="/gs/gsfs0/shared-lab/greally-lab/David/AlleleStacker_tests/AlleleStacker_11-20-24/outputs/file_paths/filepaths_CNVs.txt"
