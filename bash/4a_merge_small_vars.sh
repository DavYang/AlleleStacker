...
#SBATCH --nodes=1
#SBATCH --mem=64gb
#SBATCH --output=SNP_merge_%j.out
#SBATCH --error=SNP_merge_%j.err

# Exit on error
set -e
# Set paths
OUT_DIR="/gs/gsfs0/shared-lab/greally-lab/David/AlleleStacker_tests/AlleleStacker_11-20-24/outputs/merged_variants/small_variants"
MERGED_VCF="${OUT_DIR}/merged_phased_small_GRCh38.deepvariant.vcf.gz"
INT_VCF="${OUT_DIR}/merged_phased_small_GRCh38.deepvariant.filtered.vcf.gz"
INT_VCF_2="${OUT_DIR}/merged_phased_small_GRCh38.deepvariant.filtered.renamed.vcf.gz"
FINAL_VCF="${OUT_DIR}/merged_phased_small_GRCh38.deepvariant.qc.vcf.gz"
FILEPATHS="/gs/gsfs0/shared-lab/greally-lab/David/AlleleStacker_tests/AlleleStacker_11-20-24/outputs/file_paths/filepaths_small.txt"
...
bcftools filter -i 'QUAL>=20 && DP>=10' "$MERGED_VCF" -O z -o "$INT_VCF"
tabix -p vcf "$INT_VCF"
